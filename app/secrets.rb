...
# Prevent reversing of the storage key back to its original
# ID, as contained in the URL, by hashing the ID generated by
# the client. This prevents an attacker who gains control of
# a DB dump from being able to search for that ID globally
# (e.g. searching all email, or all Twitter, etc.). Its just
